  ...
  return (
    ...
    <div className="auth__wrapper">
      ...
      <fieldset className="auth__fieldset register__fieldset">
        ...
        <button className={`${isValid ? "auth__submit" : "auth__submit auth__submit_disabled"}`} type="submit" disabled={!isValid}>Зарегистрироваться</button>
      </form>
      <p className="auth__tip">Уже зарегистрированы? <NavLink className="auth__link" activeClassName="register__link_active" to='/signin'>Войти</NavLink></p>
    </div>
  </section>
  )
}
